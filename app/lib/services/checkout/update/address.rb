      ...
      class Address
        ...
        def save_addresses
          ActiveRecord::Base.transaction do
            @form_billing = AddressForm.new(params: @order_billing_address, current_instance: @current_order)
            @form_shipping = AddressForm.new(params: @order_shipping_address, current_instance: @current_order)
            @form_billing.save
            @form_shipping.save
