class ReviewForm
  ...
  MIN_RATING = 1
  MAX_RATING = 5
  VALIDATE_TITLE = %r{\A[a-zA-Z0-9 \!\#\$\%\&\'\*\+\-/\=\?\^\-\`\{\}\|\,\.]*\z}.freeze
  VALIDATE_BODY = %r{\A[a-zA-Z0-9 \!\#\$\%\&\'\*\+\-/\=\?\^\-\`\{\}\|\,\.]*\z}.freeze
  ...
  validates :rating, presence: true, numericality: { greater_than_or_equal_to: MIN_RATING,
